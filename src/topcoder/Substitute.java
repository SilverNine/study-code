...
public class Substitute {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(substitute.getValue("TRADINGFEW","LGXWEV"));
        System.out.println(substitute.getValue("ABCDEFGHIJ","XJ"));
        System.out.println(substitute.getValue("CRYSTALBUM","MMA"));
    }
}
